<?php include 'sistema_gibego/dist/includes/dbcon.php';?>
<?php
$titulo="";
...
<body id="page-top">
  ...
  <section class="bg-light page-section" id="galeria">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-sm-4 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
            ...
            <img class="img-fluid" src="sistema_gibego/pages/layout/images/<?php echo $imagen_galeria1;?>" alt="">
          </a>
      ...
      <img class="img-fluid" src="sistema_gibego/pages/layout/images/<?php echo $imagen_galeria2;?>"  alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Galerias</h4>
